...
#ifndef _eodeltaPlaningStat_h
#define _eodeltaPlaningStat_h
 ...
 */
template <class EOT>
class eodeltaPlaningStat : public eoStat<EOT, double>
{
public :
...
// START eventually add or modify the anyVariable argument
   ...
   */
  eodeltaPlaningStat(std::string _description = "eodeltaPlaningStat ") :
...
// END eventually add or modify the anyVariable argument
  ...
  virtual std::string className(void) const { return "eodeltaPlaningStat"; }
private :
// START Private data of an eodeltaPlaningStat object
  //  varType anyVariable;		   // for example ...
// END   Private data of an eodeltaPlaningStat object
};
